...
def create_mosaic(sde_file, mosaic_name):
    ...
    mosaic = arcpy.CreateMosaicDataset_management(in_workspace=sde_file,in_mosaicdataset_name=mosaic_name,coordinate_system=spatial_reference,num_bands="1",pixel_type="32_BIT_FLOAT",product_definition="NONE",product_band_definitions="#")
