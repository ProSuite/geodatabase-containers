...
parser.add_option("--DBMS", dest="Database_type", type="choice", choices=['SQLSERVER', 'ORACLE', 'POSTGRESQL', ''],
                  default="", help="Type of enterprise DBMS:  SQLSERVER, ORACLE, or POSTGRESQL.")
...
parser.add_option("--auth", dest="Account_authentication", type="choice",
                  ...
                  help="Authentication type options (case-sensitive):  DATABASE_AUTH, OPERATING_SYSTEM_AUTH.  "
...
parser.add_option("--schema", dest="Schema_type", type="choice", choices=['SDE_SCHEMA', 'DBO_SCHEMA'],
                  default="SDE_SCHEMA", help="Schema Type for SQL Server geodatabase, SDE or DBO. Default=SDE_SCHEMA")
...
parser.add_option("--type", dest="Spatial_type", type="choice", choices=['ST_GEOMETRY', 'POSTGIS'],
                  default="ST_GEOMETRY",
                  help="Spatial Type for PostgreSQL geodatabase, ST_GEOMETRY or POSTGIS. Default=ST_GEOMETRY")
...
try:
    ...
    if database_type == "SQL_SERVER":
        ...
        if account_authentication == "OPERATING_SYSTEM_AUTH":
            print("Warning: %s %s, %s\n" % (
                "Only database authentication is supported on", database_type,
    ...
    if product_license.upper() == "ARCVIEW" or product_license.upper() == 'ENGINE':
        print(
            ...
            " Creating an enterprise geodatabase requires an ArcGIS for Desktop Standard or Advanced, "
            "ArcGIS Engine with the Geodatabase Update extension, or ArcGIS for Server license.")
    ...
    try:
        ...
        arcpy.management.CreateEnterpriseGeodatabase(database_platform=database_type, instance_name=instance,
                                                     ...
                                                     authorization_file=license, spatial_type=spatial_type)
